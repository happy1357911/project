...
# 不在清單內時，自動改用 CPU
SUPPORTED_CC = {(5,0),(6,0),(6,1),(7,0),(7,5),(8,0),(8,6),(9,0),(8,9),(12,0)}
...
MISSING_AUG_PROFILES = {
    ...
    "m15_bc_dominant": {
        ...
        "missing_aug_strategy_weights": {
            ...
            "Task2": {"no_bc": 0.60, "partial_bc": 0.20, "multi_ac_nr": 0.10, "abg_borderline": 0.10},
    ...
    "m20_heavy_balanced": {
        ...
        "missing_aug_strategy_weights": {
            ...
            "Task2": {"no_bc": 0.50, "partial_bc": 0.20, "multi_ac_nr": 0.20, "abg_borderline": 0.10},
    ...
    "m30_stress": {
        ...
        "missing_aug_strategy_weights": {
            ...
            "Task2": {"no_bc": 0.60, "partial_bc": 0.15, "multi_ac_nr": 0.10, "abg_borderline": 0.15},
            "Task3": {"no_peak": 0.10, "no_width": 0.05, "np_like": 0.25, "no_tymp": 0.60},
        },
    },
}
...
def apply_training_missingness_augmentation(
    ...
    if task_name == "Task2":
        strategy_names = ["no_bc", "partial_bc", "multi_ac_nr", "abg_borderline"]
        strategy = sample_missingness_strategy(
            task_name,
            strategy_names,
            X.shape[0],
        ...
        abg_borderline_mask = masks["abg_borderline"]
        if bool(abg_borderline_mask.any().item()):
            for hz in TASK2_ABG_FREQS:
                set_augmented_feature(out, abg_borderline_mask, feature_to_idx, norm_for_task, f"abg_{hz}Hz", 10.0)
                set_augmented_feature(out, abg_borderline_mask, feature_to_idx, norm_for_task, f"abg_{hz}Hz_missing", 0.0)
                set_augmented_feature(out, abg_borderline_mask, feature_to_idx, norm_for_task, f"abg_{hz}Hz_censored", 0.0)
        ...
        if macro_improved:
            ...
            best_meta = {
                ...
                "missingness_augmentation": {
                    ...
                    "task2_scenarios": ["no_bc", "partial_bc", "multi_ac_nr", "abg_borderline"],

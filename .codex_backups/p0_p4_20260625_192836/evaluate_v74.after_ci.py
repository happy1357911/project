            ...
            for metric in metric_cols:
                ...
                rows.append({
                    **base,
                    ...
                    "std": std,
                    "sem": sem,
                    "ci95_low": float(values.mean() - ci95_half_width) if np.isfinite(ci95_half_width) else np.nan,
                    "ci95_high": float(values.mean() + ci95_half_width) if np.isfinite(ci95_half_width) else np.nan,
